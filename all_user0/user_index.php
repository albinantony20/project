...
?>
			<br><br><br><br>
				 <h3 class="title-w3-agileits title-black-wthree">ITEMS</h3><h3><center><a href="special_index.php" >Special Foods>>></a></h3></center>
...
{ $s=$info[$i]["item_image"];
		...
		?>		 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						...
						<img style="width:300; height:300" src=<?php echo BASE_URL."uploads/".$info[$i]["item_image"]; ?> alt=" " class="img-responsive" />
							<?php /*?> <h4>Deluxe Room</h4><?php */?>
                              ...
                              <br><br><br><h4><?php echo $info[$i]["item_price"]?></h4> 
			...
			<a href="dispaly_itemdescription.php?id=<?= $info[$i]["item_id"]?>" >VIEW</a>
							</div>
						</div>
					</div>
				</div>
